...
void funcion_filosofos( int id )
{
  ...
  while ( true )
  {
    ...
    MPI_Send( &value, 1, MPI_INT, id_cam, etiq_sentarse, MPI_COMM_WORLD );
    MPI_Recv ( &value, 1, MPI_INT, id_cam, etiq_respuesta_cam, MPI_COMM_WORLD, &estado );
    ...
    MPI_Send( &value, 1, MPI_INT, id_cam, etiq_levantarse, MPI_COMM_WORLD );
    MPI_Recv ( &value, 1, MPI_INT, id_cam, etiq_respuesta_cam, MPI_COMM_WORLD, &estado );
...
{
  int valor, etiq_aceptable, filosofos_sentados = 0;  // valor recibido, identificador del filósofo
  MPI_Status estado ;       // metadatos de las dos recepciones
  ...
  while ( true )
  {
     ...
     MPI_Send( &valor, 1, MPI_INT, estado.MPI_SOURCE, etiq_respuesta_cam, MPI_COMM_WORLD );
  }
}
// ---------------------------------------------------------------------
