...
{
   logM( "funcion_hebra: comienza hebra num: " << num_hebra );
   while( true )
   {
   ...
   logM( "funcion_hebra: acaba   hebra num: " << num_hebra );
}
// *****************************************************************************
...
int main()
{
   ...
   auto monitor = Create<MBarreraParSU>( num_hebras_cita );
   logM("monitor creado");
   ...
   {
      logM("voy a crear hebra número: "<< i);
